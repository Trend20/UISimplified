...
const TechStack = () =>{
    return (
        <section className="text-white w-full flex py-32 justify-center items-center">
            <div className="w-full px-4 py-8 sm:px-6 sm:py-12 lg:py-16 flex flex-col text-center justify-center items-center">
                <div className="max-w-xl">
                    <h2 className="text-3xl font-extrabold text-white sm:text-5xl">Tech Stack</h2>

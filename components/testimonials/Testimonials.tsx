    ...
    return (
        <div className="mx-auto max-w-5xl justify-center items-center flex flex-col px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
            <div className="max-w-xl text-center">
                <h2 className="text-3xl font-extrabold text-white sm:text-5xl">What Our Users Say</h2>

                <p className="mt-4 text-gray-400">
                    Hear from developers who have accelerated their projects with UISimplified.
                </p>
            </div>
                        ...
                        <div className="mb-8 sm:break-inside-avoid">
                            <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                                ...
                                <p className="mt-4 text-gray-700">
                                    ...
                                    delectus,
                                    maiores fugit, reiciendis culpa inventore sint accusantium libero dolore eos quasi a
                                    ex
